  ...
  return (
    <div className="page active">
      ...
      <div className="flex gap-8 mb-16">
        <input placeholder="Search merchant or description…" className="field" style={{ maxWidth: '280px' }} />
            ...
            {transactions?.map((tx) => {
              ...
              return (
                <tr key={tx.id}>
                  ...
                  <td>
                    <div className="fw600 fs13">{tx.merchant || tx.description}</div>
                    <div className="text-muted" style={{ fontSize: '11px' }}>{tx.description || 'No description'}</div>
                  </td>
                  <td>
